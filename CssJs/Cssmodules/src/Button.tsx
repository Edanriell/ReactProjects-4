...
function Button({ children, outline = false, disabled = false, className = "", width = null }) {
	const classNames = [styles.normal, outline ? styles.outline : "", className].filter(Boolean);
